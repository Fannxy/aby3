...
int fixed_matrix_mult_shift(aby3::sf64Matrix<aby3::D8>& A, aby3::sf64Matrix<aby3::D8>& B, aby3::sf64Matrix<aby3::D8>& C, int shift, int pIdx, aby3::Sh3Encryptor& enc, aby3::Sh3Evaluator& eval, aby3::Sh3Runtime& runtime);

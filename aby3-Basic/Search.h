...
int subHBS(std::vector<aby3::si64> &data, std::vector<aby3::sb64> &keyset, aby3::sbMatrix &key, aby3::si64Matrix &res, int pIdx, aby3::Sh3Encryptor& enc, aby3::Sh3Evaluator& eval, aby3::Sh3Runtime& runtime, int alpha, int threshold = 1<<8);
...
int ptaMBS(std::vector<aby3::sb64> &keyset, aby3::sbMatrix &key, aby3::sbMatrix &res, ABY3MPIPairOnlyTask<aby3::sb64, aby3::sb64, aby3::sb64, aby3::sb64, PtAMBS>* ptaTask);
...
int ptaMBSAB(std::vector<aby3::sb64> &keyset, aby3::sbMatrix &key, aby3::sbMatrix &res, aby3::si64Matrix& res_a, ABY3MPIPairOnlyTask<aby3::sb64, aby3::sb64, std::pair<aby3::si64, aby3::sb64>, std::pair<aby3::si64, aby3::sb64>, PtAMBSAB>* ptaTask);
...
int ptaMBSAB(std::vector<aby3::sbMatrix> &keyset, aby3::sbMatrix &key, aby3::sbMatrix &res, aby3::si64Matrix& res_a, ABY3MPIPairOnlyTask<aby3::sb64, aby3::sb64, std::pair<aby3::si64, aby3::sb64>, std::pair<aby3::si64, aby3::sb64>, PtAMBSAB>* ptaTask);